...
namespace Axelfvm\Tests\CarrinhoCompras;

use Mockery;
use PHPUnit\Framework\Assert;
use Axelfvm\CarrinhoCompras\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Axelfvm\CarrinhoCompras\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Axelfvm\CarrinhoCompras\ShoppingcartServiceProvider;
use Axelfvm\Tests\CarrinhoCompras\Fixtures\ProductModel;
use Axelfvm\Tests\CarrinhoCompras\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Axelfvm\CarrinhoCompras\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Axelfvm\CarrinhoCompras\Exceptions\UnknownModelException
    ...
    public function it_can_store_the_cart_in_a_database()
    {
        ...
        $this->assertDatabaseHas('carrinho_compras', ['identifier' => $identifier, 'instance' => 'default', 'content' => $serialized]);
    ...
    /**
     * @test
     * @expectedException \Axelfvm\CarrinhoCompras\Exceptions\CartAlreadyStoredException
    ...
    public function it_can_restore_a_cart_from_the_database()
    {
        ...
        $this->assertDatabaseMissing('carrinho_compras', ['identifier' => $identifier, 'instance' => 'default']);
     ...
     *
     * @return \Axelfvm\CarrinhoCompras\Cart
     */
